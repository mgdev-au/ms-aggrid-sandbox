...
import MSAgBooleanCellEditor from './MSAgBooleanCellEditor';
import MSAgBooleanCellRenderer from './MSAgBooleanCellRenderer';
...
export default class MilestoneTestRig extends Component {
    constructor(props) {
        super(props);
    ...
    static dateCellRenderer(params) {
        return MilestoneTestRig.pad(params.value.getDate(), 2) + '/' +
            MilestoneTestRig.pad(params.value.getMonth() + 1, 2) + '/' +
                        ...
                        <AgGridReact
                            ...
                            <AgGridColumn headerName="Employee" headerGroupComponentFramework={HeaderGroupComponent}>
                                <AgGridColumn field="name" width={150}
                                              ...
                                              enableRowGroup enablePivot editable/>
                                <AgGridColumn field="country" width={150}
                                              cellRenderer={MilestoneTestRig.countryCellRenderer}
                                              filterParams={{
                                                  cellRenderer: MilestoneTestRig.countryCellRenderer,
                                                  cellHeight: 20
                                              }}
                                ...
                                <AgGridColumn field="dob" width={175} headerName="DOB" filter="agDateColumnFilter"
                                              ...
                                              cellRenderer={MilestoneTestRig.dateCellRenderer}/>
                            </AgGridColumn>
                            <AgGridColumn headerName="IT Skills">
                                ...
                                <AgGridColumn field="bool" width={50}
                                              cellEditorFramework={MSAgBooleanCellEditor}
                                              cellRendererFramework={MSAgBooleanCellRenderer}
                                              editable/>
                            ...
                            <AgGridColumn headerName="Contact">
                                <AgGridColumn field="mobile" width={150} filter="text" editable/>
                                <AgGridColumn field="landline" width={150} filter="text" editable/>
                                <AgGridColumn field="address" width={500} filter="text" editable/>
                            </AgGridColumn>
                            <AgGridColumn field="eob" width={300} editable />
                            <AgGridColumn field="fob" width={300} editable />
                            <AgGridColumn field="gob" width={300} editable />
                            <AgGridColumn field="hob" width={300} editable />
                            <AgGridColumn field="iob" width={300} editable />                            
                        </AgGridReact>
                    </div>
                </div>
            </div>
